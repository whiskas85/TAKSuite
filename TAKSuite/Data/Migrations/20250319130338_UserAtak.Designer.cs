...
namespace TAKSuite.Migrations
{
    ...
    [Migration("20250319130338_UserAtak")]
    partial class UserAtak
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TAKSuite.Data.Models.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TAKSuite.Data.ApplicationUser", b =>
                {
                    b.HasOne("TAKSuite.Data.Models.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TAKSuite.Data.Models.Team", b =>
                {
                    b.HasOne("TAKSuite.Data.Models.User", "TeamLeader")
                        .WithOne("LedTeam")
